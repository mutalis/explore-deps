...
const buildRoom_1 = require("./buildRoom");
const describeMove_1 = require("./describeMove");
const findLibraryRoot_1 = require("./findLibraryRoot");
...
async function win(past) {
    output_1.output(boxen_1.default("YOU WIN!", { borderColor: "magenta", padding: 2, float: "center" }));
    return;
}
